...
// Theme
const VIDEO_THEME_OPTIONS = ['BRAND', 'VIRAL', 'PERF', 'TSTMN', 'CEL'];
// Static mode: only the approved concepts.
const STATIC_THEME_OPTIONS = ['BRAND', 'NATV', 'TSTMN', 'CEL'];
...
function App() {
  ...
  const [lexiconPage, setLexiconPage] = useState<1 | 2>(1);
        ...
        <div className="p-8 border-b border-zinc-900">
          <div className="flex items-center gap-4">
             ...
             <div className="flex flex-col leading-none">
               ...
               <p className="text-[#ffff99] text-[10px] font-bold uppercase tracking-[0.25em]">MKT Team V1.25</p>
             </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 animate-in fade-in duration-300">
           <div className="bg-zinc-950 border border-zinc-800 w-full max-w-5xl rounded-2xl relative shadow-[0_0_100px_rgba(255,255,153,0.15)] flex flex-col max-h-[90vh] overflow-hidden">
              ...
              <div className="flex items-center justify-between p-6 border-b border-zinc-800 bg-zinc-900/80">
		        ...
		        <button onClick={() => { setIsLexiconOpen(false); setLexiconQuery(''); setLexiconPage(1); }} className="text-zinc-500 hover:text-white transition-colors bg-black/40 p-2 rounded-full hover:bg-zinc-800">
                  <X size={24} />
                </button>
              </div>
                ...
                <div className="sticky top-0 z-10 -mt-6 pt-2 pb-6 bg-gradient-to-b from-black/90 to-black/50 backdrop-blur">
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between gap-3">
                      <div className="text-zinc-500 text-xs font-bold uppercase tracking-[0.2em]">Pages</div>
                      <div className="flex items-center gap-2">
                        <button
                          type="button"
                          onClick={() => setLexiconPage(1)}
                          className={`text-xs font-bold uppercase tracking-widest rounded-lg px-3 py-2 border transition-colors ${
                            lexiconPage === 1
                              ? 'bg-[#ffff99] text-black border-[#ffff99]'
                ...
                {lexiconPage === 2 && (
                  <div className="space-y-10">
                    <div className="rounded-2xl border border-zinc-800 bg-zinc-900/20 p-6">
                      <div className="flex items-center gap-3">
                        <div className="bg-[#ffff99] text-black px-2 py-1 rounded-md text-[10px] font-bold uppercase tracking-widest">
                          Updated 2026
                        </div>
                        <div className="text-zinc-400 text-sm">
                          Quick guide to the <span className="text-white">Concept Themes</span> + dos/don'ts.
                        </div>
                      </div>
                      <div className="mt-3 text-xs text-zinc-500">
                        Static styles are aligned to the same strategic intent as video. Keep the structure, swap the medium.
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="rounded-2xl border border-zinc-800 bg-black/40 p-6">
                        <div className="flex items-center justify-between gap-4">
                          <div>
                            <div className="text-[#ffff99] font-mono font-bold">PERF</div>
                            <div className="text-white font-semibold">Performance</div>
                          </div>
                          <div className="text-[10px] text-zinc-400 uppercase tracking-widest">Video + Static</div>
                        </div>
                        <div className="mt-4 text-sm text-zinc-400">
                          Goal: trigger immediate action. Problem → solution → proof → CTA.
                        </div>
                        <div className="mt-4 grid grid-cols-1 gap-3 text-xs text-zinc-500">
                          <div className="border border-zinc-800 rounded-xl p-3">
                            <div className="text-white font-semibold mb-1">Do</div>
                            Thumbstoppers, clear problem framing, proof (before/after, reviews), heavy on-screen text, fast pacing, product early.
                          </div>
                          <div className="border border-zinc-800 rounded-xl p-3">
                            <div className="text-white font-semibold mb-1">Don't</div>
                            Start with pretty lifestyle, vague product claims, assume sound on, slow emotional build.
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="rounded-2xl border border-zinc-800 bg-black/40 p-6">
                        <div className="flex items-center justify-between gap-4">
                          <div>
                            <div className="text-[#ffff99] font-mono font-bold">VIRAL</div>
                            <div className="text-white font-semibold">Viral</div>
                          </div>
                          <div className="text-[10px] text-zinc-400 uppercase tracking-widest">Video</div>
                        </div>
                        <div className="mt-4 text-sm text-zinc-400">
                        ...
                        <div className="mt-4 grid grid-cols-1 gap-3 text-xs text-zinc-500">
                          <div className="border border-zinc-800 rounded-xl p-3">
                            <div className="text-white font-semibold mb-1">Do</div>
                            Copy real viral formats (POV, reaction, storytime), keep it imperfect/phone-feel, light captions, soft native CTA.
                          </div>
                          <div className="border border-zinc-800 rounded-xl p-3">
                            <div className="text-white font-semibold mb-1">Don't</div>
                            Studio polish, over-script, hard DR framers (“Stop scrolling”), stacked titles, or skipping CTA.
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="rounded-2xl border border-zinc-800 bg-black/40 p-6">
                        <div className="flex items-center justify-between gap-4">
                          <div>
                            <div className="text-[#ffff99] font-mono font-bold">BRAND</div>
                            <div className="text-white font-semibold">Branded</div>
                          </div>
                          <div className="text-[10px] text-zinc-400 uppercase tracking-widest">Video + Static</div>
                        </div>
                        <div className="mt-4 text-sm text-zinc-400">
                          Goal: aspiration and emotion. Elevated visuals. Minimal copy. Feed-safe.
                        </div>
                        <div className="mt-4 grid grid-cols-1 gap-3 text-xs text-zinc-500">
                          <div className="border border-zinc-800 rounded-xl p-3">
                            <div className="text-white font-semibold mb-1">Do</div>
                            Beautiful, art-directed visuals. Let music or design carry the vibe. Slow, intentional pacing (video).
                          </div>
                          <div className="border border-zinc-800 rounded-xl p-3">
                            <div className="text-white font-semibold mb-1">Don't</div>
                            Ugly/problem footage, heavy sales text, fast DR energy, or hard CTA/offer overlays.
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="rounded-2xl border border-zinc-800 bg-black/40 p-6">
                        <div className="flex items-center justify-between gap-4">
                          <div>
                            <div className="text-[#ffff99] font-mono font-bold">NATV</div>
                            <div className="text-white font-semibold">Native</div>
                          </div>
                          <div className="text-[10px] text-zinc-400 uppercase tracking-widest">Static</div>
                        </div>
                        <div className="mt-4 text-sm text-zinc-400">
                          Goal: look like an influencer Story. Unsponsored vibe. Casual proof + casual CTA.
                        </div>
                        <div className="mt-4 grid grid-cols-1 gap-3 text-xs text-zinc-500">
                          <div className="border border-zinc-800 rounded-xl p-3">
                            <div className="text-white font-semibold mb-1">Do</div>
                            Phone photo, Story-style text, casual language, natural setting, DM/poll-style proof.
                          </div>
                          <div className="border border-zinc-800 rounded-xl p-3">
                            <div className="text-white font-semibold mb-1">Don't</div>
                            Branded fonts/layouts, centered product shot, formal sales copy, button-style CTAs.
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="rounded-2xl border border-zinc-800 bg-black/40 p-6">
                        <div className="flex items-center justify-between gap-4">
                          <div>
                            <div className="text-[#ffff99] font-mono font-bold">TSTMN</div>
                            <div className="text-white font-semibold">Testimonial</div>
                          </div>
                          <div className="text-[10px] text-zinc-400 uppercase tracking-widest">Video + Static</div>
                        </div>
                        <div className="mt-4 text-sm text-zinc-400">
                          Goal: let real people (or real quotes) sell it. Specific claims + proof + simple CTA.
                        </div>
                        <div className="mt-4 grid grid-cols-1 gap-3 text-xs text-zinc-500">
                          <div className="border border-zinc-800 rounded-xl p-3">
                            <div className="text-white font-semibold mb-1">Do</div>
                            Lead with the strongest quote/result, show receipts (ratings, screenshots, before/after), keep copy literal, make the product connection obvious.
                          </div>
                          <div className="border border-zinc-800 rounded-xl p-3">
                            <div className="text-white font-semibold mb-1">Don't</div>
                            Use generic praise (“love this!”), hide the product, over-style the layout, or bury the claim under aesthetic fluff.
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="rounded-2xl border border-zinc-800 bg-black/40 p-6">
                        <div className="flex items-center justify-between gap-4">
                          <div>
                            <div className="text-[#ffff99] font-mono font-bold">CEL</div>
                            <div className="text-white font-semibold">Celebrity</div>
                          </div>
                          <div className="text-[10px] text-zinc-400 uppercase tracking-widest">Video + Static</div>
                        </div>
                        <div className="mt-4 text-sm text-zinc-400">
                          Goal: borrow attention + trust from recognizable talent while keeping the product story crystal clear.
                        </div>
                        <div className="mt-4 grid grid-cols-1 gap-3 text-xs text-zinc-500">
                          <div className="border border-zinc-800 rounded-xl p-3">
                            <div className="text-white font-semibold mb-1">Do</div>
                            Talent in the first second, strong product tie-in, simple claim, clear brand moment, and a clean CTA. Keep it premium and uncluttered.
                          </div>
                          <div className="border border-zinc-800 rounded-xl p-3">
                            <div className="text-white font-semibold mb-1">Don't</div>
                            Assume people know the context, overload with text, or let celebrity presence replace proof/benefit clarity.
                          </div>
                        </div>
                      </div>
